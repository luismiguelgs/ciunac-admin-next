...
export default function ButtonAsignRequest({ setReload, setData }: Props) 
{
    ...
    return (
        <React.Fragment>
            ...
            <DialogFull
                ...
                content={
                    <RequestList setOpenDialogFull={setOpenDialogFull} setReload={setReload} setRequest={setData} />
                }
            />
        </React.Fragment>
    )
